...
<div class="am-collapse am-topbar-collapse" id="collapse-head">
  @if (Auth::check())
    ...
    <ul class="am-nav am-nav-pills am-topbar-nav">
        <li class="{{ (isset($page) and ($page == 'users')) ? 'am-active' : '' }}"><a href="{{ URL::to('admin/users') }}">管理用户</a></li>
        <li class="{{ (isset($page) and ($page == 'articles')) ? 'am-active' : '' }}"><a href="{{ URL::to('admin/articles') }}">管理文章</a></li>
        <li class="{{ (isset($page) and ($page == 'tags')) ? 'am-active' : '' }}"><a href="{{ URL::to('admin/tags') }}">管理标签</a></li>
    </ul>
    @endif
    <div class="am-topbar-right">
      <div class="am-dropdown" data-am-dropdown="{boundary: '.am-topbar'}">
        ...
        <ul class="am-dropdown-content">
          ...
          <li><a href="{{ URL::to('user/'. Auth::id() . '/edit') }}"><span class="am-icon-user"></span>设置</a></li>
